    ...
    <div className="min-h-screen flex flex-col justify-between">
        ...
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-teal-100">Track and manage your purchases</p>
            </div>
          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              {[
                ...
                {
                  label: "Delivered",
                  value: orderData.filter((item) => item.status === "Delivered")
                    .length,
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between border-t pt-3">
                      ...
                      <Link
                        to={`/product/${item._id}`}
                        className="text-teal hover:text-teal-700 text-sm font-semibold hover:underline"
                      >
                        View Details →
                      </Link>
                    </div>
      ...
      <div className=" shadow-lg py-6 mt-8">
        <div className="max-w-screen-lg mx-auto text-center">
          ...
          <Link to="/contact">
            <button className="text-teal hover:text-teal-700 font-medium">
              Contact Support →
            </button>
          </Link>
        </div>
